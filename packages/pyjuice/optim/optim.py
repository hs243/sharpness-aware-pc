...
class CircuitOptimizer():
    ...
    def __init__(self, pc: TensorCircuit, base_optimizer: Optional[Optimizer] = None, method: str = "EM", lr: float = 0.1,
                 pseudocount: float = 0.1,reg_lam:float=1.0,reg_mu:float=0.0,eta:float=None,phi:Literal["entropy","laplacian","local_trace","global_trace","local_trace_1","local_trace_2"]=None, **kwargs):
